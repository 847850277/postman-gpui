...
pub use history_snapshot::{
    HeaderSnapshotV1, HistoricalResponseBodySnapshotV2, HistoricalResponseSnapshotV2,
    HistorySensitiveDataPolicy, HistorySnapshotError, HistorySnapshotV1, HistorySnapshotV2,
    ...
    VersionedHistorySnapshot, HISTORY_SNAPSHOT_VERSION_V1, HISTORY_SNAPSHOT_VERSION_V2,
    MAX_HISTORICAL_RESPONSE_PREVIEW_BYTES,
};
