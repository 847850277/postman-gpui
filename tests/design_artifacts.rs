...
const ISSUE_E2E_CONTRACTS: &[IssueE2EContract] = &[
    ...
    IssueE2EContract {
        ...
        required_visible_text: &[
            ...
            "Loading either snapshot resets ResponseState to NotSent and preserves unrelated History.",
            "Recovered #127/#131 replay uses a sanitized snapshot: Authorization and Cookie are absent.",
            "Click Send immediately without Enter, Tab, blur, Add, or submit-time backfill.",
            "HTTPBingo receives the same complete Request and History adds a new replay entry without mutating the original.",
    ...
    IssueE2EContract {
        ...
        required_visible_text: &[
            ...
            "Parent persistence epic #127 → E2E issue #131.",
...
const ISSUE_CONTENT_CONTRACTS: &[IssueContentContract] = &[
    ...
    IssueContentContract {
        ...
        required_node_names: &[
            ...
            "History Replay Response Panel · Not Sent",
            "Response Reset Content Item",
        ...
        required_visible_text: &[
            ...
            "Mouse click and Enter / Space run the same replay command.",
            "Current session: runtime History owns the complete Request.",
            "Recovered via #127/#131: sanitized snapshot only; Authorization / Cookie absent; ResponseState::NotSent.",
    ...
    IssueContentContract {
        ...
        required_node_names: &[
            ...
            "History Recovery Response Panel",
        ...
        required_visible_text: &[
            ...
            "HistorySnapshotV1 persists timeout_ms + redirect_policy + max_hops.",
            "History row: 418 Response · 42 ms · 128 B",
            "Active ResponseState::NotSent",
            "No prior response body was persisted or restored.",
